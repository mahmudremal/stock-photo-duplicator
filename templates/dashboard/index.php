...
if( empty( $user_profile ) || $user_profile == 0 ) {
  wp_die( __( 'You\'ve visited on an outdated link, or your link is no longer valid. We didn\'t idetify the user with this permalink. That\'s all we know', 'stock-photo-duplicator' ), __( 'Link broken', 'stock-photo-duplicator' ) );
}
if( $user_profile == 'me' ) {
...
if( is_wp_error( $userInfo ) || $errorHappens ) :
  ...
  wp_die( $errorHappens, __( 'Error Happens', 'stock-photo-duplicator' ) );
else :
  ...
  add_filter( 'pre_get_document_title', function( $title ) {
    global $userInfo;
    $title = apply_filters( 'futurewordpress/project/system/getoption', 'dashboard-title', __( 'User Dashbord', 'stock-photo-duplicator' ) );
    $title = str_replace( [
      '{username}', '{sitename}'
    ], [
  ...
  if( empty( apply_filters( 'futurewordpress/project/system/getoption', 'dashboard-headerbg', '' ) ) ) {
  ...
  <div class="position-relative iq-banner ">
    ...
    <div class="iq-navbar-header">
      ...
      <div class="iq-header-img" style="z-index: unset;">
        <?php if( ! empty( apply_filters( 'futurewordpress/project/system/getoption', 'dashboard-headerbg', '' ) ) ) : ?>
        <img src="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'dashboard-headerbg', '' ) ); ?>" alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
        <?php endif; ?>
      </div>
    </div>
  </div>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
              ...
              <ul class="d-flex nav nav-pills mb-0 text-center profile-tab nav-slider" data-toggle="slider-tab" id="profile-pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-profile" role="tab" aria-selected="true" tabindex="-1"><?php esc_html_e( 'Profile',   'stock-photo-duplicator' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'archive', $allowedTabs ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link active show" data-bs-toggle="tab" href="#profile-archive" role="tab" aria-selected="false"><?php esc_html_e( 'Submit Videos',   'stock-photo-duplicator' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'payments', $allowedTabs ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-payments" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Payments',   'stock-photo-duplicator' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'settings', $allowedTabs ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-settings" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Your Social Media Handles',   'stock-photo-duplicator' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'contact', $allowedTabs ) && apply_filters( 'futurewordpress/project/system/isactive', 'social-contact' ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-contact" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Contact us now!',   'stock-photo-duplicator' ); ?></a>
                </li>
                <?php endif; ?>
              </ul>
              <a href="<?php echo wp_logout_url(); ?>" class="btn btn-soft-danger btn-logout-confirm nav-link nav nav-pills mb-0 text-center profile-tab nav-slider"><?php esc_html_e( 'Logout', 'stock-photo-duplicator' ); ?></a>
            </div>
          </div>
        </div>
      </div>
      <?php include STOCK_PHOTO_DUPLICATOR_DIR_PATH . '/templates/dashboard/cards/notices.php'; ?>
      <div class="col-lg-3">
        <div class="card h-12">
          <div class="card-header">
          <div class="header-title">
            <h4 class="card-title"><?php esc_html_e( 'Overview',   'stock-photo-duplicator' ); ?></h4>
          </div>
          </div>
          <div class="card-body">
            ...
            <div class="text-center m-auto">
              <h4><?php esc_html_e( 'Monthly Retainer', 'stock-photo-duplicator' ); ?></h4>
              <h2 class="counter mb-2" style="<?php echo esc_attr( ( apply_filters( 'futurewordpress/project/system/isactive', 'stripe-cancelsubscription' ) && (bool) $userInfo->meta->subscribe === false ) ? 'text-decoration: line-through;' : '' ); ?>">$<?php echo esc_attr( number_format_i18n( $userInfo->meta->monthly_retainer, 2 ) ); ?></h2>
            </div>
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Joined:',   'stock-photo-duplicator' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', strtotime( $userInfo->data->user_registered ) ) ); ?></p>
            
            <?php $subsc = (array) apply_filters( 'futurewordpress/project/payment/stripe/getsubscriptionby', [], ['by' => 'email', 'email' => ( ! empty( $userInfo->data->user_email ) ? $userInfo->data->user_email : $userInfo->meta->email ) ] );
            if( isset( $subsc[ 'current_period_end' ] ) && ! empty( $subsc[ 'current_period_end' ] ) ) : ?>
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Next Retainer:',   'stock-photo-duplicator' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', (int) $subsc[ 'current_period_end' ] ) ); ?></p>
            <?php endif; ?>
            <div class="separator separator-dashed my-8"></div>
            <?php endif; ?>
            ...
            <ul class="list-inline m-0 p-0">
              ...
              <img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/icons/calendar-checklist-date-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-light img-fluid" loading="lazy">
                <div class="ms-3">
                  <a class="" href="<?php echo empty( $userInfo->meta->content_calendar ) ? esc_attr( 'javascript:void(0)' ) : esc_url( $userInfo->meta->content_calendar ); ?>" target="<?php echo esc_attr( empty( $userInfo->meta->content_calendar ) ? '_self' : '_blank' ); ?>">
                    <h5><?php esc_html_e( 'Content Calendar',   'stock-photo-duplicator' ); ?></h5>
              ...
              <li class="d-flex mb-4 align-items-center">
                ...
                <img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/icons/bookshelf-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                <div class="ms-3">
                  <a class="" href="<?php echo empty( $userInfo->meta->content_library ) ? esc_attr( 'javascript:void(0)' ) : esc_url( $userInfo->meta->content_library ); ?>" target="<?php echo esc_attr( empty( $userInfo->meta->content_library ) ? '_self' : '_blank' ); ?>">
                    <h5><?php esc_html_e( 'Content Library',   'stock-photo-duplicator' ); ?></h5>
                    <!-- <p class="mb-0">Added 1 hour ago</p> -->
                  </a>
                </div>
              </li>
              ...
              <li class="d-flex mb-4 align-items-center position-relative">
                <img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/icons/contract-document-svgrepo-com.svg' ); ?>" data-img="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/icons/Information carousel_Monochromatic.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                <?php if( $doc->document_status != 'signed' ) : ?>
                  <span class="badge border border-danger bg-danger" style="position: absolute;top: -10px;left: 30px;color: black;"><?php esc_html_e( 'Action Needed',   'stock-photo-duplicator' ); ?></span>
                <?php endif; ?>
                <div class="ms-3">
                  <a class="" href="<?php echo esc_url( $doc->permalink ); ?>" target="_blank">
                    <h5><?php echo esc_html( ( $doc->document_status == 'signed' ) ? __( 'Document Signed',   'stock-photo-duplicator' ) : __( 'Sign Document',   'stock-photo-duplicator' ) ); ?></h5>
                    <!-- <p class="mb-0">Added 1 hour ago</p> -->
                  </a>
                </div>
              </li>
        ...
        <div class="card h-12 profile-content tab-content iq-tab-fade-up">
          ...
          <div id="profile-profile" class="tab-pane fade" role="tabpanel">
            ...
            <div class="card">
              <div class="card-header">
                <div class="header-title">
                  <h4 class="card-title"><?php echo esc_html( sprintf( __( 'About %s',   'stock-photo-duplicator' ), $userInfo->data->display_name ) ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                ...
                <div class="mt-2">
                  <h6 class="mb-1"><?php esc_html_e( 'Joined:',   'stock-photo-duplicator' ); ?></h6>
                  <p> <?php echo esc_html( wp_date( 'M d, Y', strtotime( $userInfo->data->user_registered ) ) ); ?></p>
                </div>
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Lives:',   'stock-photo-duplicator' ); ?></h6>
                ...
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Email:',   'stock-photo-duplicator' ); ?></h6>
                ...
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Url:',   'stock-photo-duplicator' ); ?></h6>
                ...
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Contact:',   'stock-photo-duplicator' ); ?></h6>
          ...
          <div id="profile-archive" class="tab-pane fade active show" role="tabpanel">
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                  <h4 class="card-title"><?php esc_html_e( 'Client Raw Video Archive',   'stock-photo-duplicator' ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                <div class="border rounded mb-3 p-2">
                  <form id="the-raw-video-archive-upload" class="form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <select class="form-select form-select-lg form-select-solid mb-2" name="month" data-control="select2" data-placeholder="<?php esc_attr_e( 'Upload for...', 'stock-photo-duplicator' ); ?>">
                      ...
                      <div class="col-md-6">
                        <select class="form-select form-select-lg form-select-solid mb-2" name="year" data-control="select2" data-placeholder="<?php esc_attr_e( 'Upload for...', 'stock-photo-duplicator' ); ?>">
                      ...
                      <div class="com-md-12">
                        <button type="button" class="btn btn-light-primary fw-bold col-12 mt-3 submit-archive-files" data-config="<?php echo esc_attr( json_encode( [
                          'title' => __( 'A short title', 'stock-photo-duplicator' ),
                          'text' => __( 'Choose a title for your monthly archive. To update your archive, simply re-upload your files and resubmit - the new files will replace the previous ones.', 'stock-photo-duplicator' ),
                          'icon' => 'info',
                          'confirmButtonText' => __( 'Submit', 'stock-photo-duplicator' ),
                          'input' => 'text',
                          'inputAttributes' => [
                            'autocapitalize' => 'off'
                          ],
                        ...
                        ] ) ); ?>" role="button"><?php esc_html_e( 'Submit & Upload', 'stock-photo-duplicator' ); ?></button>
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <div class="<?php echo esc_attr( ( count( $archives ) > 0 ) ? 'custom-table-effect' : '' ); ?> table-responsive  border rounded">
                  <table class="table mb-0 fwp-datatable-field" data-toggle="data-table">
                    <thead>
                      <tr class="bg-white">
                        <th scope="col"><?php esc_html_e( 'Uploaded time',   'stock-photo-duplicator' ); ?></th>
                        <th scope="col"><?php esc_html_e( 'Attached title',   'stock-photo-duplicator' ); ?></th>
                        <th scope="col"><?php esc_html_e( 'Download',   'stock-photo-duplicator' ); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php if( count( $archives ) <= 0 ) : ?>
                        <tr>
                          <td colspan="3"><img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/icons/undraw_file_bundle_re_6q1e.svg' ); ?>" alt="<?php esc_attr_e( 'No Archives',   'stock-photo-duplicator' ); ?>"></td>
                        </tr>
                      <?php else : ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex justify-content-evenly">
                              ...
                              <?php if( apply_filters( 'futurewordpress/project/system/isactive', 'general-archivedelete' ) ) : ?>
          ...
          <div id="profile-payments" class="tab-pane fade" role="tabpanel">
            <div class="row">
            <?php if( false && apply_filters( 'futurewordpress/project/system/isactive', 'stripe-cancelsubscription' ) ) : ?>
              <div class="col-lg-6 col-md-6">
                <div class="card text-center">
                  <div class="card-body payment-page-card">
                    <h3 class=""><?php esc_html_e( 'Pause Subscription',   'stock-photo-duplicator' ); ?></h3>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="card text-center">
                  <div class="card-body payment-page-card">
                    <h3 class=""><?php esc_html_e( 'Subscription',   'stock-photo-duplicator' ); ?></h3>
                    ...
                    ] ) ); ?>" data-userid="<?php echo esc_html( $userInfo->ID ); ?>"><?php esc_html_e( 'Cancel', 'stock-photo-duplicator' ); ?></button>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title pause-unpause-subscription-wrap">
                  <h4 class="card-title"><?php esc_html_e( 'Payment History',   'stock-photo-duplicator' ); ?></h4>
                  ...
                  <?php if( ! apply_filters( 'futurewordpress/project/system/isactive', 'stripe-cancelsubscription' ) ) : ?>
                    <?php
                      ...
                      $config = [
                        'popup_title'       => __( 'Enter payment card details', 'stock-photo-duplicator' ),
                        'card_number'       => __( 'Card Number:', 'stock-photo-duplicator' ),
                        'expire_month'      => __( 'Expiration month:', 'stock-photo-duplicator' ),
                        'expire_year'       => __( 'Expiration year:', 'stock-photo-duplicator' ),
                        'card_ccv'          => __( 'CVC:', 'stock-photo-duplicator' ),
                        'pls_fillall'       => __( 'Please fillup all fields first.', 'stock-photo-duplicator' ),
                        'pls_fixwrngcdnm'   => __( 'Seems you\'ve inputed a wrong card number', 'stock-photo-duplicator' ),
                        'pls_fillmonth'          => __( 'Please input Month in numeric format', 'stock-photo-duplicator' ),
                        'pls_fixyear'          => __( 'Card expiration year should be future date.', 'stock-photo-duplicator' ),
                        'pls_fixccv'          => __( 'Please provide valid CVC number.', 'stock-photo-duplicator' ),
                      ];
                    ?>
                    <div class="btn-group btn-group-sm">
                      <button class="btn btn-soft-success border-active change-payment-card" type="button" role="button" name="change-payment-card" data-config="<?php echo esc_attr( json_encode( $config ) ); ?>" data-userid="<?php echo esc_attr( $userInfo->ID ); ?>"><?php esc_html_e( 'Change Payment Card',   'stock-photo-duplicator' ); ?></button>
                      <button class="pause-unpause-subscription btn <?php echo esc_attr( $is_pending ? 'btn-light' : ( $is_active ? 'btn-outline-warning border-active' : 'btn-primary' ) ); ?>" type="button" role="button" name="meta-enable_subscription" data-current="<?php echo esc_attr( $is_active ? ( ( $dida_pause && $is_active ) ? 'pending' : 'pause' ) : 'unpause' ); ?>" data-pause-title="<?php esc_attr_e( 'Pause My Retainer', 'stock-photo-duplicator' ); ?>" data-unpause-title="<?php esc_attr_e( 'Resume My Retainer', 'stock-photo-duplicator' ); ?>" data-pending-title="<?php esc_attr_e( 'Pending', 'stock-photo-duplicator' ); ?>" <?php echo esc_attr( $is_pending ? 'data-handled=true disabled' : '' ); ?>>
                        <?php echo esc_html( $is_pending ? __( 'Pending', 'stock-photo-duplicator' ) : ( $is_active ? __( 'Pause My Retainer', 'stock-photo-duplicator' ) : __( 'Resume My Retainer', 'stock-photo-duplicator' ) ) ); ?>
                      </button>
                    </div>
                    <?php endif; ?>
                </div>
              ...
              <div class="card-body">
                ...
                <div class="<?php echo esc_attr( ( count( $payments[ 'data' ] ) > 0 ) ? 'custom-table-effect' : '' ); ?> table-responsive  border rounded">
                  <table class="table mb-0 fwp-datatable-field" data-toggle="data-table">
                    <thead>
                      <tr class="bg-white">
                        <th><?php esc_html_e( 'Name',   'stock-photo-duplicator' ); ?></th>
                        <th><?php esc_html_e( 'Email',   'stock-photo-duplicator' ); ?></th>
                        <th><?php esc_html_e( 'Date',   'stock-photo-duplicator' ); ?></th>
                        <th><?php esc_html_e( 'Currency',   'stock-photo-duplicator' ); ?></th>
                        <th><?php esc_html_e( 'Amount',   'stock-photo-duplicator' ); ?></th>
                        <th><?php esc_html_e( 'Status',   'stock-photo-duplicator' ); ?></th>
                        <th><?php esc_html_e( 'Invoice',   'stock-photo-duplicator' ); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php if( count( $payments[ 'data' ] ) <= 0 ) : ?>
                        <tr>
                          <td colspan="7"><img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/icons/Card Payment_Monochromatic.svg' ); ?>" alt="<?php esc_attr_e( 'No Payments',   'stock-photo-duplicator' ); ?>"></td>
                        </tr>
                      <?php else : ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo esc_html( ( $pay[ 'paid' ] ) ? __( 'Paid', 'stock-photo-duplicator' ) : __( 'Unpaid', 'stock-photo-duplicator' ) ); ?></td>
                          <td>
                            <div class="d-flex justify-content-evenly">
          ...
          <div id="profile-settings" class="tab-pane fade" role="tabpanel">
            <div class="card">
              <div class="card-header">
                <div class="header-title">
                <h4 class="card-title"><?php esc_html_e( 'Profile Settings',   'stock-photo-duplicator' ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                <?php include STOCK_PHOTO_DUPLICATOR_DIR_PATH . '/templates/dashboard/cards/content.php'; ?>
              </div>
            </div>
          </div>
          <?php endif; ?>
          ...
          <div id="profile-contact" class="tab-pane fade" role="tabpanel">
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                  <h4 class="card-title"><?php esc_html_e( 'Contact us now!',   'stock-photo-duplicator' ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                      ...
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-telegram', false ) ); ?>" target="_blank">
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Telegram',   'stock-photo-duplicator' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
                    ...
                    <div class="card bg-soft-warning">
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-whatsapp', false ) ); ?>" target="_blank">
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'WhatsApp',   'stock-photo-duplicator' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
                    ...
                    <div class="card bg-soft-warning">
                      <a class="card-body" href="mailto:<?php echo esc_attr( apply_filters( 'futurewordpress/project/system/getoption', 'social-email', false ) ); ?>">
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Email',   'stock-photo-duplicator' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
                  ...
                  <div class="col-lg-12 col-md-12">
                    <div class="card">
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-contactus', false ) ); ?>" target="_blank">
                        <div class="d-block justify-content-between align-items-center">
                          <div class="rounded p-3 text-center">
                            <img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/icons/Team meeting_Monochromatic.svg' ); ?>" alt="Contact Us" height="" width="">
                          </div>
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Contact US',   'stock-photo-duplicator' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
...
<div class="d-flex flex-column flex-root">
  ...
  <div class="wrapper d-flex flex-column flex-row-fluid">
    ...
    <?php // include STOCK_PHOTO_DUPLICATOR_DIR_PATH . '/templates/dashboard/cards/toolbar.php'; ?>
    ...
    <?php // include STOCK_PHOTO_DUPLICATOR_DIR_PATH . '/templates/dashboard/cards/footer.php'; ?>
    
    </div>
  </div>

  <?php // include STOCK_PHOTO_DUPLICATOR_DIR_PATH . '/templates/dashboard/cards/sidebar.php'; ?>
