...
<div>
  <div class="row">
    ...
    <div class="card card-full-width rounded m-auto to-print-this-card">
        ...
        <div class="row">
          <div class="col-sm-12">  
          <h4 class="mb-3"><?php esc_html_e( 'Invoice', 'stock-photo-duplicator' ); ?>  #<?php echo esc_html( substr( $log->session_id, -20 ) ); ?></h4>
        ...
        <div class="row">
          ...
          <p><?php echo esc_html( apply_filters( 'futurewordpress/project/system/getoption', 'general-address', 'Address not available' ) ); ?> <br>
          <?php echo esc_html( get_option( 'admin_email', '' ) ); ?></p>
          </div>
          <div class="col-lg-3">
          <h5><?php esc_html_e( 'Bill from:', 'stock-photo-duplicator' ); ?></h5>
          <p><?php echo esc_html( $userInfo->meta->first_name . ' ' . $userInfo->meta->last_name ); ?></p>
          <p><?php echo esc_html( ! empty( $userInfo->meta->address1 ) ? $userInfo->meta->address1 : (
            ! empty( $userInfo->meta->address2 ) ? $userInfo->meta->address2 : __( 'Address not available', 'stock-photo-duplicator' )
          ) ); ?><br>
            <?php echo esc_html( $log->customer_email ); ?> </p>
          </div>
          <div class="col-lg-3">
          <h5><?php esc_html_e( 'Bill fromAmount:', 'stock-photo-duplicator' ); ?></h5>
          <h4>$<?php echo esc_html( number_format_i18n( ( $log->amount / 100 ), 2 ) ); ?></h4>
          </div>
          <div class="col-lg-2 text-end">
          <h5><?php esc_html_e( 'Invoice Date', 'stock-photo-duplicator' ); ?></h5>
        ...
        <div class="row">
          ...
          <div class="table-responsive-lg">
              ...
              <thead>
                <tr>
                  <th scope="col"><?php esc_html_e( 'Description', 'stock-photo-duplicator' ); ?></th>
                  <th scope="col"><?php esc_html_e( 'Price', 'stock-photo-duplicator' ); ?></th>
                  <th scope="col"><?php esc_html_e( 'Quantity', 'stock-photo-duplicator' ); ?></th>
                  <th class="text-end" scope="col"><?php esc_html_e( 'Sub-Total', 'stock-photo-duplicator' ); ?></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="border-bottom-0">
                    <h6 class="mb-0"><?php echo esc_html( ( $text = apply_filters( 'futurewordpress/project/system/getoption', 'stripe-productname', '' ) && ! empty( $text ) ) ? $text : 'Monthly Retainer' ); ?></h6>
                    <p class="mb-0"><?php echo esc_html( ( $text = apply_filters( 'futurewordpress/project/system/getoption', 'stripe-productdesc', '' ) && ! empty( $text ) ) ? $text : '' ); ?></p>
                  </td>
                ...
                <tr>
                  <td>
                    <h5 class="mb-0"><b><?php esc_html_e( 'Net Amount', 'stock-photo-duplicator' ); ?></b></h5>
                  </td>
                  <td></td>
                  <td></td>
