    ...
    <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
            <a href="../dashboard/index.html" class="navbar-brand">
                ...
                <div class="logo-main">
                    <div class="logo-normal">
                        <img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/icons/crm-crm (1).svg' ); ?>" style="height: 30px;width: 40px;">
                    </div>
                    <div class="logo-mini">
                        <img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/icons/crm-crm (1).svg' ); ?>" style="height: 30px;width: 40px;">
                    </div>
                ...
                <!--logo End-->
                <h4 class="logo-title d-block d-xl-none" data-setting="app_name"><?php esc_html_e( 'CRM Dashboard', 'stock-photo-duplicator' ); ?></h4>
            </a>
            ...
            <div class="d-flex align-items-center justify-content-between product-offcanvas">
                ...
                <small class="mb-0 text-capitalize"><?php esc_html_e( 'Home', 'stock-photo-duplicator' ); ?></small>
                </div>
