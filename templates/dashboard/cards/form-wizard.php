    ...
    <form id="register-existing-account-wizard" class="mt-3 text-center" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
      ...
      <ul id="top-tab-list" class="p-0 row list-inline">
        <li class="mb-2 col-lg-3 col-md-6 text-start active" id="account">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Account', 'stock-photo-duplicator' ); ?></span>
          </a>
        </li>
        <li id="social" class="mb-2 col-lg-3 col-md-6 text-start">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Social', 'stock-photo-duplicator' ); ?></span>
          </a>
        </li>
        <li id="payment" class="mb-2 col-lg-3 col-md-6 text-start">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Payment', 'stock-photo-duplicator' ); ?></span>
          </a>
        </li>
        <li id="contract" class="mb-2 col-lg-3 col-md-6 text-start">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Contract', 'stock-photo-duplicator' ); ?></span>
          </a>
        </li>
      </ul>
      <!-- fieldsets -->
      <fieldset class="active">
        <div class="form-card text-start mb-2">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4"><?php esc_html_e( 'Account & Personal Information:', 'stock-photo-duplicator' ); ?></h3>
            </div>
            <!-- <div class="col-5">
              <h2 class="steps mb-4"><?php esc_html_e( 'Step 1 - 4', 'stock-photo-duplicator' ); ?></h2>
            </div> -->
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Email:', 'stock-photo-duplicator' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'First Name:', 'stock-photo-duplicator' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Last Name:', 'stock-photo-duplicator' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Display Name:', 'stock-photo-duplicator' ); ?>: *</label>
            ...
            <div class="col-md-6">
              <div class="form-group my-1">
                <label class="form-label"><?php esc_html_e( 'Password:', 'stock-photo-duplicator' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group my-1">
                <label class="form-label"><?php esc_html_e( 'Confirm Password:', 'stock-photo-duplicator' ); ?> *</label>
                <div class="input-group has-validation">
        ...
        <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Next"><?php esc_html_e( 'Next', 'stock-photo-duplicator' ); ?></button>
      </fieldset>
      <fieldset class="">
        <div class="form-card text-start">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4"><?php esc_html_e( 'Socials & Connection:', 'stock-photo-duplicator' ); ?></h3>
            </div>
            <div class="col-5">
              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 2 - 4', 'stock-photo-duplicator' ); ?></h2> -->
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <label class="form-label"><?php esc_html_e( 'TikTok Handle:', 'stock-photo-duplicator' ); ?></label>
              <div class="form-group input-group">
                  <span class="input-group-text" id="tiktok-handle">@</span>
                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'TikTok Handle:', 'stock-photo-duplicator' ); ?>" aria-describedby="tiktok-handle" name="metadata[tiktok]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->tiktok ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'YouTube Handle:', 'stock-photo-duplicator' ); ?></label>
                <div class="form-group input-group">
                  <span class="input-group-text" id="youtube-handle">@</span>
                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'YouTube Handle:', 'stock-photo-duplicator' ); ?>" aria-describedby="youtube-handle" name="metadata[YouTube_url]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->YouTube_url ); ?>">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Instagram Handle:', 'stock-photo-duplicator' ); ?></label>
                <div class="form-group input-group">
                  <span class="input-group-text" id="instagram-handle">@</span>
                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'YouTube Handle:', 'stock-photo-duplicator' ); ?>" aria-describedby="instagram-handle" name="metadata[instagram_url]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->instagram_url ); ?>">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Website Url:', 'stock-photo-duplicator' ); ?></label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'City:', 'stock-photo-duplicator' ); ?></label>
                <input type="text" class="form-control" name="metadata[city]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->city ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'State:', 'stock-photo-duplicator' ); ?></label>
                <input type="text" class="form-control" name="metadata[state]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->state ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Zip Code:', 'stock-photo-duplicator' ); ?></label>
        ...
        <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Next"><?php esc_html_e( 'Next', 'stock-photo-duplicator' ); ?></button>
        <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-end me-1" value="Previous"><?php esc_html_e( 'Previous', 'stock-photo-duplicator' ); ?></button>
      </fieldset>
      <fieldset class="">
        <div class="form-card text-start">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4"><?php esc_html_e( 'Payment:', 'stock-photo-duplicator' ); ?></h3>
              <!-- <h3 class="mb-4"><?php esc_html_e( 'Image Upload:', 'stock-photo-duplicator' ); ?></h3> -->
            </div>
            <div class="col-5">
              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 3 - 4', 'stock-photo-duplicator' ); ?></h2> -->
            </div>
          </div>
          <div class="row">
                ...
                <div class="card rounded-3">
                  <div class="card-body mx-1 my-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <p class="d-flex flex-column mb-0">
                          <b><?php esc_html_e( 'Pay to proceed on contract.', 'stock-photo-duplicator' ); ?></b>
                        </p>
                      </div>
                    </div>
                      ...
                      <div class="d-flex flex-row pb-3">
                        <div class="rounded border border-primary border-2 d-flex w-100 p-3 align-items-center"
                          ...
                          <div class="d-flex flex-column">
                            <p class="mb-1 small text-primary"><?php esc_html_e( 'Monthly Retainer', 'stock-photo-duplicator' ); ?></p>
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-1">
                      <!-- <a href="<?php echo esc_url( site_url( 'pay_retainer/' . $userInfo->ID . '/' ) ); ?>" class="btn btn-primary btn-lg pay_retainer-amount" target="_blank"><?php esc_html_e( 'Pay amount',   'stock-photo-duplicator' ); ?></a> -->
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- <div class="col-sm-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Upload Your Photo:', 'stock-photo-duplicator' ); ?></label>
        ...
        <!-- <a type="button" href="<?php echo esc_url( site_url( 'pay_retainer/' . $userInfo->ID . '/' ) ); ?>" target="_blank" name="pay-amount" class="btn btn-primary next action-button float-end" value="Submit"><?php esc_html_e( 'Pay Amount', 'stock-photo-duplicator' ); ?></a> -->
        <button type="submit" name="submit" class="btn btn-primary next action-button float-end" value="Submit"><?php esc_html_e( 'Submit', 'stock-photo-duplicator' ); ?></button>
        <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-end me-1" value="Previous"><?php esc_html_e( 'Previous', 'stock-photo-duplicator' ); ?></button>
      </fieldset>
      <fieldset class="">
        <div class="form-card">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4 text-left"><?php esc_html_e( 'Finish:', 'stock-photo-duplicator' ); ?></h3>
            </div>
            <div class="col-5">
              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 4 - 4', 'stock-photo-duplicator' ); ?></h2> -->
            </div>
          </div>
          <br>
          <br>
          <h2 class="text-center text-success">
            <strong><?php esc_html_e( 'SUCCESS !', 'stock-photo-duplicator' ); ?></strong>
          </h2>
          <br>
          <div class="row justify-content-center">
            <div class="col-3">
              <img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/img/img-success.png' ); ?>" class="img-fluid" alt="fit-image" loading="lazy">
            </div>
          </div>
          <br>
          <br>
          <div class="row justify-content-center">
            <div class="text-center col-7">
              <h5 class="text-center purple-text"><?php esc_html_e( 'You Have Successfully Signed Up', 'stock-photo-duplicator' ); ?></h5>
            </div>
          </div>
        </div>
      </fieldset>
