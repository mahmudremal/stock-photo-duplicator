...
//   'result' => $result
//   ] );
$result = apply_filters( 'futurewordpress/project/payment/stripe/handlesuccess', $session_id );
      ...
      <div class="row no-gutters align-items-center bg-white">      
        <div class="col-md-12 col-lg-6 align-self-center">
          <div class="navbar-brand d-flex align-items-center mb-3 justify-content-center text-primary">
            ...
            <h2 class="logo-title ms-3 mb-0" data-setting="app_name"><?php echo esc_html( ( $result[ 'payment_status' ] == 'paid' ) ? __( 'Payment Successful',   'stock-photo-duplicator' ) : __( 'Payment Failed',   'stock-photo-duplicator' ) );
            esc_html_e( '',   'stock-photo-duplicator' ); ?></h2>
          </div>
          <div class="row justify-content-center pt-5">
            <div class="col-md-8">
              <div class="card  d-flex justify-content-center mb-0">
              <div class="card-body">
                  <h2 class="mt-3 mb-4"><?php echo esc_html( ( $result[ 'payment_status' ] == 'paid' ) ? __( 'Success !',   'stock-photo-duplicator' ) : __( 'Failed !',   'stock-photo-duplicator' ) ); ?></h2>
                  <p class="cnf-mail mb-1"><?php echo wp_kses_post( ( $result[ 'payment_status' ] == 'paid' ) ? 
                  __( 'Congratulations! Your subscription has been successfully processed. As a next step, please click here to sign the necessary documents and complete the process. Thank you for choosing us and we look forward to serving you. If you have any questions or concerns, please don\'t hesitate to reach out to us. We are always here to help.',   'stock-photo-duplicator' ) : 
                  __( nl2br( "Unfortunately, your payment has failed.\nDon\'t worry,we understand that things happen. To try again, please click the button below. \nIf you need assistance or have any questions, please reach out to our support team for help. \n\nPlease note that until your payment is successful, you will not be able to proceed with the contract. We encourage you to try again as soon as possible. Thank you for your understanding." ),   'stock-photo-duplicator' ) ); ?></p>
                  <div class="d-inline-block w-100">
                    <a href="<?php echo esc_url( apply_filters( 'futurewordpress/project/user/dashboardpermalink', $userInfo->ID, $userInfo->data->user_nicename ) ); ?>/sign/" class="btn btn-primary mt-3"><?php esc_html_e( 'Sign the Document',   'stock-photo-duplicator' ); ?></a>
                  </div>
              </div>
            </div>
            </div>
        ...
        <div class="col-lg-6 d-lg-block d-none bg-primary p-0  overflow-hidden">
          ...
          <img src="<?php echo esc_url( STOCK_PHOTO_DUPLICATOR_BUILD_URI . '/img/img-to-contract.jpg' ); ?>" class="img-fluid gradient-main" alt="images" loading="lazy" >
        </div>
      </div>
    </section>
  </div>
