...
class Bulks {
	...
	protected function setup_hooks() {
		$this->args = [
			...
			'column'	=> 'status',
			'options'	=> [
				''       => __( 'All', 'stock-photo-duplicator' ),
				'open'   => __( 'Open', 'stock-photo-duplicator' ),
				'closed' => __( 'Closed', 'stock-photo-duplicator' ),
			]
		];
		/**
		 ...
		 */
		add_action( 'wp_ajax_futurewordpress/project/status/switch', [ $this, 'ajax_switch' ], 10, 0 );
		add_action( 'wp_ajax_nopriv_futurewordpress/project/status/switch', [ $this, 'ajax_switch' ], 10, 0 );
	}
	/**
	...
	public function manage_posts_columns( $columns ) {
		...
		$columns[ $this->args[ 'column' ] ] = __( 'Status', 'stock-photo-duplicator' );
		return $columns;
	}
	/**
	...
	public function manage_posts_custom_column( $column, $post_id ) {
		if( $this->args[ 'column' ] == $column ) {
			$args = [
				'confirm'	=> true,
				'request'	=> [
					'action'		=> 'futurewordpress/project/status/switch',
					'post_id'		=> $post_id,
					'status'		=> false
				]
			];
