...
class Widgets_CustomCategory extends \Elementor\Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_style( 'listivo-child-widgets', STOCK_PHOTO_DUPLICATOR_BUILD_CSS_URI . '/widgets.css', [], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, STOCK_PHOTO_DUPLICATOR_BUILD_CSS_DIR_PATH . '/widgets.css' ) );

		wp_register_script( 'swiper', site_url( '/wp-content/plugins/elementor/assets/lib/swiper/swiper.min.js' ), [], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, ABSPATH . '/wp-content/plugins/elementor/assets/lib/swiper/swiper.min.js' ), true );

		wp_register_script( 'listivo-child-widgets', STOCK_PHOTO_DUPLICATOR_BUILD_JS_URI . '/widgets.js', [ 'swiper' ], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, STOCK_PHOTO_DUPLICATOR_BUILD_JS_DIR_PATH . '/widgets.js' ), true );
...
stock-photo-duplicator
		return __( 'Custom Category Slider', 'stock-photo-duplicator' );
...
stock-photo-duplicator
	 ...
	 * Used to determine where to display thestock-photo-duplicatoror.
...
stock-photo-duplicator
	...
	public function get_categories() stock-photo-duplicator
...
stock-photo-duplicator
	...
	public function get_script_depends() stock-photo-duplicator
...
stock-photo-duplicator
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			'section_content',stock-photo-duplicator

			array(

				'label' => __( 'Content', 'stock-photo-duplicator' ),

			)

		);

		$this->add_control(stock-photo-duplicator

			'show_view_all',stock-photo-duplicator

			[

				'label' => esc_html__('Display "View All" button', 'stock-photo-duplicator'),

				'type' => Controls_Manager::SWITCHER,stock-photo-duplicator

				'return_value' => '1',stock-photo-duplicator
		...
		$this->add_control(
			...
			[
stock-photo-duplicator
				'label' => esc_html__('Style', 'stock-photo-duplicator'),

				'type' => Controls_Manager::SELECT,

				'options' => [

					'left' => esc_html__('Left', 'stock-photo-duplicator'),

					'right' => esc_html__('Right', 'stock-photo-duplicator'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Heading Text', 'stock-photo-duplicator' ),

				'type'    => Controls_Manager::TEXT,

				'default' => __( 'Heading Text', 'stock-photo-duplicator' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Show button', 'stock-photo-duplicator'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('View All Text', 'stock-photo-duplicator'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Button Text', 'stock-photo-duplicator' ),

				'type'    => Controls_Manager::TEXT,

				'default' => __( 'View all', 'stock-photo-duplicator' ),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'View all button link', 'stock-photo-duplicator' ),
		...
		$this->add_control(
				...
				[
						...
						'label' => esc_html__('Image', 'stock-photo-duplicator'),
		...
		$this->start_controls_section(
			...
			array(
				...
				'label' => __( 'Slider', 'stock-photo-duplicator' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category Label', 'stock-photo-duplicator'),

				'type' => Controls_Manager::TEXT,

				'placeholder' => __( 'Title Here', 'stock-photo-duplicator' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category URL', 'stock-photo-duplicator'),

				'type' => Controls_Manager::TEXT,

				'placeholder' => __( 'Full URL of this category.', 'stock-photo-duplicator' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Background Color', 'stock-photo-duplicator'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Category Items', 'stock-photo-duplicator'),
